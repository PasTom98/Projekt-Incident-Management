...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("IncidentStatusListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheIncidentStatusListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheIncidentStatusListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheIncidentStatusListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheIncidentStatusListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheIncidentStatusListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheIncidentStatusListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheIncidentStatusListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheIncidentStatusListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheIncidentStatusListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheIncidentStatusObjectPageGenerated.iSeeThisPage();
        });
