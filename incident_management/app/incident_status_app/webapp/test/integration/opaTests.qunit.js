...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "incidentstatus/incidentstatusapp/test/integration/IncidentStatusListJourney.gen",
    "incidentstatus/incidentstatusapp/test/integration/IncidentStatusObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
