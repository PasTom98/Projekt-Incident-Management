...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "incidentmanagement/incidentmanagement/test/integration/IncidentsListJourney.gen",
    "incidentmanagement/incidentmanagement/test/integration/IncidentsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
